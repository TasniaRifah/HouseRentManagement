...
class CourseRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if(CourseRequest::isMethod('post')){
            return [
                'title' => 'required|max:100|unique:courses',
                'batch_no' => 'required|unique:courses',
            ...
            return [
                'title' => 'required|max:100|unique:courses,title,'.$this->route('course')->id,
                'batch_no' => 'required|max:100|unique:courses,batch_no,'.$this->route('course')->id,
